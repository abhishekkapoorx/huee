...
const Eyes = () => {
    ...
    return (
        <div className='relative -z-10 w-full bg-[url("./Top-Viewbbcbv-1-scaled.jpg")] h-screen bg-cover bg-center flex items-center justify-center' data-scroll-speed="-6" data-scroll>
